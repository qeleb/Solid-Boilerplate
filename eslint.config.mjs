...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      ...
      // 'unicorn/prefer-hoisting-branch-code': 'warn', // Broken
      'unicorn/prefer-identifier-import-export-specifiers': 'warn',
      'unicorn/prefer-import-meta-properties': 'warn',
      'unicorn/prefer-includes': 'warn',
      'unicorn/prefer-includes-over-repeated-comparisons': ['warn', { minimumComparisons: 4 }],
      ...
      'unicorn/prefer-string-repeat': ['warn', { minimumRepetitions: 12 }],
